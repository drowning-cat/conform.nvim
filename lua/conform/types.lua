...
---@field formatters_by_ft? table<string|string[], conform.FiletypeFormatter> Map of filetype to formatters. It supports tables as keys (only works within the setup function).
